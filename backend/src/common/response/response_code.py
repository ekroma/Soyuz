...
class CustomCodeBase(Enum):
    """Base class for custom status codes"""
...
class CustomResponseCode(CustomCodeBase):
    ...
    HTTP_201 = (201, 'Creation request successful')
    HTTP_202 = (202, 'Request accepted but not yet processed')
    ...
    HTTP_425 = (425, 'Unable to execute request due to server inability to meet requirements')
    HTTP_429 = (429, 'Too many requests, server limit')
    HTTP_500 = (500, 'Internal server error')
    HTTP_502 = (502, 'Bad gateway')
    HTTP_503 = (503, 'Service temporarily unavailable')
...
class CustomResponse:
    """
    Provides open response status codes instead of enums. This can be useful if you want to customize the response message.
    """
